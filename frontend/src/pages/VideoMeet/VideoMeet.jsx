                    ...
                    {showModal ?
                        <div className="chat-room">
                            ...
                            <div className="chatting-area">
                                <TextField className='chat-input' value={message} onChange={(e) => setMessage(e.target.value)} id="outlined-basic" label="Enter Your chat" variant="outlined" />
                        ...
                        {videos.map((video) => (
                            <div key={video.socketId}>
                                ...
                                <video
                                    ...
                                    data-screenshare={video.isScreenShare ? "true" : "false"}
                                    ref={ref => {
                                        if (ref && video.stream) {
